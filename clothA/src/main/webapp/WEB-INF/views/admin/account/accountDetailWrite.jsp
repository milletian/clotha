						...
						success : function(res) {
							if (res.length > 0) {
								...
								$.each(res, function(idx, item) {
									var dsd = "<tr><td>" + item.PD_CODE
											+ "</td>" + "<td>"
											+ item.PD_NAME + "</td>"
											+ "<td>" + item.STOCK_QTY
											+ "</td>" + "<td>"
											+ item.PD_ORIGINALPRICE
											+ "</td>" + "<td>"
											+ item.PD_SELLPRICE + "</td>"
											+ "<td>"
									if (item.PD_DEL == 'Y') {
										dsd += "사용";
									} else {
...
.row {
	...
	<h3 class="smaller lighter blue no-margin modal-title">구매등록</h3>
</div>

<div class="modal-body">
	<div id="wrap">
		<form name="accDetailWritefrm" id="accDetailWritefrm" method="post"
			action="<c:url value='/admin/account/accountDetailWrite.do' />">
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						<label for="searchRegDate" class="col-sm-4 control-label">주문일자</label>
						<div class="col-sm-8">
							<input type="text" class="form-control searchDate"
								id="searchRegDate" name="accDtRegdate">
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control searchDate"
								id="searchInDate" name="accDtIndate">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="whCode" class="form-control" name="whCode"
								readonly="readonly">
						</div>
					</div>
				</div>
				<div class="col-sm-2">
					<div class="form-group">
						<div class="col-sm-8">
							<a data-toggle="modal" data-target="#modal-searchWh"
								role="button" data-backdrop="static"> <span
								class="btn btn-primary">창고검색</span>
							</a>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="pdCode" class="form-control" name="pdCode"
								readonly="readonly">
						</div>
					</div>
				</div>
				<div class="col-sm-1">
					<div class="form-group">
						<div class="col-sm-8">
							<a data-toggle="modal" data-target="#modal-searchPd"
								role="button" data-backdrop="static"> <span
								class="btn btn-primary">상품검색</span>
							</a>
						</div>
					</div>
				</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="accName" class="form-control"
								name="accName" readonly="readonly">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="accDtQty" name="accDtQty"
								class="form-control">
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						<label for="pdOriginalprice" class="col-sm-4 control-label">개당
							원가</label>
						<div class="col-sm-8">
							<input type="text" id="pdOriginalprice" name="pdOriginalprice"
				...
				<div class="col-sm-4">
					<div class="form-group">
						<label for="pdSellprice" class="col-sm-4 control-label">개당
							판매가</label>
						<div class="col-sm-8">
							<input type="text" id="pdSellprice" name="pdSellprice"
								class="form-control" readonly="readonly">
						</div>
					</div>
				</div>
			...
			<input type="hidden" id="accCode" name="accCode"> <br>
...
<div class="modal-footer">
	<span class="btn btn-sm btn-success" id="submit"> 저장<i
		class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
	</span>
	<button class="btn btn-sm btn-danger pull-right" data-dismiss="modal"
		id="btnAccountDetailClose">
