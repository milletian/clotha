...
<div class="modal-header bg-primary" >
	...
	$(function() {
		...
		$('#accountWrite').click(function() {
			var bool = true;
			var CpNumber = $('form[name=frmAccWrite] #accNo').val();
			...
			if(bool){
				if(!CorporationNumber(CpNumber)){
					bool=false;
					$('form[name=frmAccWrite] #accNo').prev().focus();
				}
			}
			if(bool){
				$.ajax({
					url:"<c:url value='/admin/account/ajaxAccountWrite.do' />",
					//data:$("#frmAccWrite").serialize(),
					headers:{
	              		"Content-Type":"application/json"
	          		},
					data:{"accCode":$('#frmAccWrite #accCode').val(),
						"accName":$('#frmAccWrite #accName').val(),
						"accIsdeal":$('#frmAccWrite #accIsdeal').val(),
						"accCeo":$('#frmAccWrite #accCeo').val(),
						"accTel":$('#frmAccWrite #accTel').val(),
						"accNo":$('#frmAccWrite #accNo').val(),
						"accZipcode":$('#frmAccWrite #accZipcode').val(),
						"address":$('#frmAccWrite #address').val(),
						"addressDetail":$('#frmAccWrite #addressDetail').val(),
						"accUnique":$('#frmAccWrite #accUnique').val()},
					dataType:'text',
