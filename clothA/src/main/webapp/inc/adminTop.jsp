...
<body>
	...
	<aside class="sidebar" >
		<div class="logo" >
			<a href="<c:url value='/manager.do'/>" style="text-align: left;"><img alt="" src="<c:url value='/images/logo5.png'/>" style="width: 240px; height: 57px; "></a>
		</div>
		<div id="leftside-navigation" class="nano">
			<ul class="nano-content">
				...
				<li class="sub-menu"><a href="javascript:void(0);"><i
						...
						class="arrow fa fa-angle-right pull-right"></i></a>
					<ul>
						<li><a href="<c:url value='/store/sales/salesList.do'/>" target="if">매장별 판매 현황</a></li>
